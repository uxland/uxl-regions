...
regionManager.registerViewWithRegion('multiRegion', 'view1', {
  sortHint: '001',
  factory: spanFactory('view1'),
});
regionManager.registerViewWithRegion('multiRegion', 'view2', {
  sortHint: '003',
  factory: spanFactory('view2'),
});
regionManager.registerViewWithRegion('multiRegion', 'view3', {
  sortHint: '000',
  factory: spanFactory('view3'),
});
regionManager.registerViewWithRegion('multiRegion', 'view4', {
  sortHint: '002',
  factory: spanFactory('view4'),
});
